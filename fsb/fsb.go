...
func NewErrorDirectResponse(err error) *DirectResponse {
...
func NewOKRawResponse(node *JNode) *CallResponse {
	return &CallResponse{
		Verdict:  "OK",
		Response: node,
	}
...
type DirectServiceWithContext func(kargs interface{}, context map[string]interface{}) (res *DirectResponse)
